            ...
            <div class="card">
                <div class="card-body">
                    <div class="text-sm-right">
                        <a href="{{route('authors.create')}}" type="button" class="btn btn-success btn-rounded waves-effect waves-light mb-2 mr-2">
                    ...
                    <table id="datatable" class="table table-bordered dt-responsive nowrap"
                        ...
                        @forelse ($authors as $author)
                            ...
                            <tr class="row1" data-id="{{ $author->id }}">
                                ...
                                <td>{{$author->name}}</td>
                                <td><img src="/storage/author-image/{{ $author->image }}" width="100" height="50"></td>

                                <td>
                                    <div class="float-right d-flex">
                                        <a href="{{route('authors.edit', $author->id) }}" class="btn btn-outline-primary btn-sm edit mr-2" title="Edit">
